...
export interface CourseSummaryRouteResponse extends Pick<Review, 'quality' | 'ease' | 'overall' | 'grade' | 'tags'>,
    Pick<Course, 'id' | 'name' | 'description' | 'courseNumber' | 'department' | 'prereqs' | "units" | 'satisfiesArea'> {
