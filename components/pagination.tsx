...
function PaginationNumber({
  ...
  const className = clsx(
    'flex max-lg:h-6 max-lg:min-w-[24px] w-fit px-1 lg:h-10 lg:min-w-[40px] items-center justify-center max-lg:text-caption lg:text-body default-border animation',
    {
      'rounded-l-sm': position === 'first' || position === 'single',
      'rounded-r-sm': position === 'last' || position === 'single',
      'z-10 bg-primary border-primary-900 text-background': isActive,
...
const PaginationArrow = ({
  ...
  const className = clsx(
    'flex max-lg:h-6 max-lg:w-6 lg:h-10 lg:w-10 items-center justify-center rounded-sm default-border animation',
    {
